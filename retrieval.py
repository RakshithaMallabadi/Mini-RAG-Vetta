...
class RetrievalSystem:
    """Unified retrieval system supporting semantic and hybrid search"""
    
    def __init__(self, embedding_vector_store: EmbeddingVectorStore):
        """
    ...
    def search(self, 
        ...
        if mode == "semantic":
            ...
            return self.hybrid_retriever.search_bm25_only(query, k=k)
